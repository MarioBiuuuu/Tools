...
- (void)configureConstraintsForSubviews
{
    ...
    rectangularView.layer.cornerRadius = sizeRectangular * 0.5;
    
    dotView.frame = CGRectMake(0, 0, sizeDot, sizeDot);
    dotView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) + sizeDot * 1.8);
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    CGFloat opacity = 1.;
    rectangularView.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    if(selected){
        ...
        if(!self.isOtherMonth){
            ...
            rectangularView.layer.borderColor = [UIColor whiteColor].CGColor;
            rectangularView.layer.borderWidth = 1;
        }
        else{
